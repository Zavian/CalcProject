...
namespace CalcProject {
    public partial class mainForm : Form {
        ...
        private void button1_Click(object sender, EventArgs e) {
            ...
            for (int i = 0; i < t.nSVars; i++) {
                dg.Columns[i+2].HeaderText = "x" + (i + 1);
            }
            dg.Columns[t.nSVars + 2].HeaderText = "b";
            ...
            for (int r = 0; r < t.Functions.Length /*Da aggiungere il +1 per Cj */; r++) {
                ...
                for (int c = 0; c < t.nVars + 1; c++) {
                    if(c < t.nVars) dg[c + 2, r].Value = t.coefficientTerms[r][c];
